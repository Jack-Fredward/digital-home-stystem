...
class stanely_vinni_bedroom:
    def __init__(self, name, dbCursor):
        ...
        self.lights = device("stanely_vinni_bedroom Lights",dbCursor)
        self.lights.actuators.append(actuator("stanely_vinni_bedroom Light Actuator","stanely_vinni_bedroom Lights",dbCursor))
        self.lights.sensors.append(brightSensor("SVLBS","stanely_vinni_bedroom Lights", dbCursor))
        self.lights.sensors.append(motionSensor("SVLMS","stanely_vinni_bedroom Lights", dbCursor))
        ...
        self.doors = []
        self.doors.append(device("SVinteriordoor",dbCursor))
        self.doors[0].actuators.append(actuator("stanely_vinni_bedroom Interior Door Actuator", "SVinteriodoor",dbCursor))
        self.doors[0].sensors.append(openCloseSensors("SVIDOCS","SVinteriordoor",dbCursor))
        
        #-------------------------------------------------------------
        #   WINDOWS
        #-------------------------------------------------------------
        
        self.windows = device("stanely_vinni_bedroom window",dbCursor)
        self.windows.append(device("stanely_vinni_bedroom window",dbCursor))
        self.windows.actuators.append(actuator("stanely_vinni_bedroom window Actuator", "stanely_vinni_bedroom window",dbCursor))
        self.windows.sensors.append(openCloseSensors("SVWOCS","stanely_vinni_bedroom window",dbCursor))
        ...
        self.air.sensors.append(tempSensor("SVATS","Air",dbCursor))
        self.air.actuators.append(actuator("stanely_vinni_bedroom Air Actuator","Air",dbCursor))

        #-------------------------------------------------------------
        #   CAMERAS
        #-------------------------------------------------------------
        
        self.cameras = device("stanely_vinni_bedroom Camera",dbCursor)
        self.cameras.append(device("stanely_vinni_bedroom Camera",dbCursor))
        self.cameras.actuators.append(actuator("stanely_vinni_bedroom Camera Actuator","stanely_vinni_bedroom Camera",dbCursor))
        self.cameras.sensors.append(motionSensor("SVCMS","stanely_vinni_bedroom Camera",dbCursor))
        ...
        self.smokealarm.sensor.append(SmokeSensor("SVSS","Smoke Alarm", dbCursor))
    ...
    #   smoke detector
    #-------------------------------------------------------------
        self.smokealarm = device("stanely_vinni_bedroom Detector", dbCursor)
        self.smokealarm.sensor.append(SmokeSensor("SVSS","", dbCursor))
